...
- `android/`：Compose 客户端、Supabase 邮箱六位 OTP 登录、带 Bearer Token 的 Retrofit 客户端、可查看/修订/删除的 Memory Center、系统分享入口、卡片确认状态机，以及只接受确认快照的 Calendar/Contacts Provider executor。
