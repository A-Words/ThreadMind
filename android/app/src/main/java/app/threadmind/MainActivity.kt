...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        handleShare(intent)
        setContent { MaterialTheme { ThreadMindScreen(viewModel) } }
    }
...
private fun ThreadMindScreen(viewModel: MainViewModel) {
    ...
    Scaffold(topBar = { TopAppBar(title = { Text("ThreadMind") }) }) { padding ->
        LazyColumn(
